...
handle_extension() {
    case "${FILE_EXTENSION_LOWER}" in
        ...
        ## JSON
        json)
            env COLORTERM=8bit bat --color=always --style="${BAT_STYLE}" --theme="${BAT_THEME}" --language=json -- "${FILE_PATH}" && exit 5
        ...
        ## Jupyter Notebooks
        ipynb)
            jupyter nbconvert --to markdown "${FILE_PATH}" --stdout | env COLORTERM=8bit bat --color=always --style=plain --language=markdown --theme=${BAT_THEME} && exit 5
        ...
        js|ts)
            ...
            env COLORTERM=8bit bat --color=always --style="${BAT_STYLE}" --theme="${BAT_THEME}" --language=javascript -- "${FILE_PATH}" && exit 5
            env COLORTERM=8bit bat --color=always --style="${BAT_STYLE}" --theme="${BAT_THEME}" --language=typescript -- "${FILE_PATH}" && exit 5
            env COLORTERM=8bit bat --color=always --style="${BAT_STYLE}" --theme="${BAT_THEME}" -- "${FILE_PATH}" && exit 5
            ;;
    esac
}
    ...
    case "${mimetype}" in
        ...
        *sqlite3)
        ...
        text/* | */xml)
            ...
            env COLORTERM=8bit bat --color=always --style="${BAT_STYLE}" --theme="${BAT_THEME}" \
                -- "${FILE_PATH}" && exit 5
